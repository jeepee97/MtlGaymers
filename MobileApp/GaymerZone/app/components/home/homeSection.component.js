...
export const HomeSectionComponent = (props) => {
    return (
        <View style={homeSectionStyle.view}>
            <Pressable android_ripple={{color: '#dddddd'}} style={homeSectionStyle.pressable}>
                <FontAwesomeIcon icon={props.icon} size={40} style={homeSectionStyle.icon}/>
